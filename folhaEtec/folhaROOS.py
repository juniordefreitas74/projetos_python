...
# ------------------------------------------------------
pasta_saida = os.path.join(BASE_DIR, "folharoos")
...
# ------------------------------------------------------
dados = pd.read_excel(os.path.join(BASE_DIR, "lisroo.xlsx"))
...
for numero_pagina in range(1, TOTAL_PAGINAS + 1):
    ...
    shutil.copy(os.path.join(BASE_DIR, "folharoos.xlsx"), nome_arquivo)
...
saida_final = os.path.join(BASE_DIR, "FOLHA_ROOS_IMPRESSAO.pdf")
